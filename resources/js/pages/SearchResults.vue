<template>
    <div class="container altezza margin-nav">
        ...
        <div>
            ...
            >
                <div v-if="success_F" class="alert alert-success slide-in-top _alert text-center">Filtri applicati</div>
                <!-- stanze e letti -->
                <div class="col p-3">
        ...
        <div>
            ...
            >
                ...
                <div class="col-4 block d-none d-lg-block">
                    ...
                    <router-link class="mt-5 float-right bottone rosso-background ombra mx-1" :to="{ name: 'show', params: { slug: app.apartment.slug }}">Dettagli</router-link>
                </div>
            </div>
        </div>
    </div>
...
/* ----------------------------------------------
 * Generated by Animista on 2021-11-2 12:11:29
